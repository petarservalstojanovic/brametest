    ...
    return function (u) {
      return (function (c) {
        ...
        for (; a && ((a = 0), c[0] && (i = 0)), i; )
          try {
            if (
              ((t = 1), r && (o = 2 & c[0] ? r.return : c[0] ? r.throw || ((o = r.return) && o.call(r), 0) : r.next) && !(o = o.call(r, c[1])).done)
            )
              return o;
...
function h(e, n) {
  ...
  switch (((c = [0, 0]), (u = [0, 0]), r)) {
    ...
    case 9:
      (u = s((u = f(u, [0, e.charCodeAt(t + 8)])), p)), (i = f(i, (u = s((u = d(u, 33)), h))));
    case 8:
              ...
              [
                ...
                new Promise(function (e, t) {
                  ...
                  var c = function () {
                    ...
                    o ||
                      ("complete" ===
                      (null === (n = null === (e = l.contentWindow) || void 0 === e ? void 0 : e.document) || void 0 === n ? void 0 : n.readyState)
                        ? a()
                        : setTimeout(c, 10));
                  };
                  c();
            ...
            case 0:
              return E((e = D()))
                ? P
                  ? [2, r([], P, !0)]
                  : M()
                  ? [4, ((t = document), (t.exitFullscreen || t.msExitFullscreen || t.mozCancelFullScreen || t.webkitExitFullscreen).call(t))]
                  : [3, 2]
                : [3, 2];
            case 1:
...
function T(e) {
  ...
  return n(this, void 0, void 0, function () {
    ...
    return t(this, function (t) {
      switch (t.label) {
        case 0:
          for (n = document, a = n.createElement("div"), i = new Array(e.length), c = {}, B(a), s = 0; s < e.length; ++s)
            "DIALOG" === (u = A(e[s])).tagName && u.show(), B((l = n.createElement("div"))), l.appendChild(u), a.appendChild(l), (i[s] = u);
          t.label = 1;
        case 1:
...
var ne = {
    ...
    return (function (e, n) {
      ...
      return X(function (t, o) {
        ...
        (c.width = "".concat(n, "px")),
          ...
          S() ? (i.style.zoom = "".concat(1 / o.devicePixelRatio)) : x() && (i.style.zoom = "reset");
                ...
                try {
                  ...
                  switch ((a(r) && u(r), e.state)) {
                    case "running":
                      ...
                      break;
                    case "suspended":
                      document.hidden || d++, s && d >= n ? l(R("suspended")) : setTimeout(v, t);
                  }
                } catch (o) {
                  l(o);
                }
  ...
  timezone: function () {
    ...
    var r,
      o = ((r = new Date().getFullYear()), -Math.max(b(new Date(r, 0, 1).getTimezoneOffset()), b(new Date(r, 6, 1).getTimezoneOffset())));
  ...
  platform: function () {
    ...
    return "MacIntel" === e && x() && !F()
      ? (function () {
          ...
          var e = screen,
            n = e.width / e.height;
          return g(["MediaSource" in window, !!Element.prototype.webkitRequestFullscreen, n > 0.65 && n < 1.53]) >= 2;
        })()
        ? "iPad"
        : "iPhone"
      : e;
  ...
  touchSupport: function () {
    var e,
      n = navigator,
      t = 0;
    void 0 !== n.maxTouchPoints ? (t = p(n.maxTouchPoints)) : void 0 !== n.msMaxTouchPoints && (t = n.msMaxTouchPoints);
    try {
  ...
  return JSON.stringify(
    ...
    function (n, t) {
      return t instanceof Error
        ? e({ name: (r = t).name, message: r.message, stack: null === (o = r.stack) || void 0 === o ? void 0 : o.split("\n") }, r)
        : t;
      var r, o;
    },
    2
